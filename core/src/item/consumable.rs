...
use crate::{general_tick, identity::uniq::Uuid, item::{container::StorageSpace, matter::{Matter, MatterState}, ownership::Owner}, mob::{StatType, StatValue, affect::{Affect, Affector}}, room::environ::{SpecialEnvironment, Terrain}, traits::{Reflector, TickMeaning, Tickable}};
...
impl Tickable for ConsumableMatter {
    fn tick(&mut self, _curr_tick: usize, _room_env: SpecialEnvironment, _: Option<Terrain>) -> Option<Vec<TickMeaning>> {
