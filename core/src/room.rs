...
use crate::{
    combat::Battler, r#const::{CPU_CORES, PER_CORE_SEMAPHORE_BUCKET_SZ, ROOM_PULSE_NTH_TICK}, error::CgError, identity::{IdentityQuery, MachineId, MachineIdentity, uniq::{StrUuid, UuidValidator}}, io::{Broadcast, room_fp}, item::{Item, container::{ContainerIterator, storage::{Storage, StorageError, StorageMut, StorageQueryError, StorageSpace}, variants::{ContainerVariant, ContainerVariantType}}}, mob::{EntityArc, ai::AiAction}, player::PlayerWeak, rng::*, room::{
        environ::*,
